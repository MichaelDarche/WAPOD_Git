...
import os
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/Homogeneous_PointSource-Willis/")
...
Nmat,rho,cm,S1=inputReading.materialWillis(mat)
alpha=inputReading.frontiere(frontiere)
rhox,Celx,S1x=inputReading.affectMaterialsWillis(alpha,rho,cm,S1,xmin,xmax,Nx,dx)
...
K=2
#Res,V,Sig=scheme1D.FD_sourceVWillis(U0,Nt,Nx,K,rhox,Celx,S1x,dt,dx,x_0,sce,1)
...
K=4
Res,V0,S0=scheme1D.FD_sourceVWillis(U0,Nt,Nx,K,rhox,Celx,S1x,dt,dx,x_0,sce,1)
...
with open("V-Iter824.txt", "r") as fichier:
