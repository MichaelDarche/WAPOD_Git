...
import os
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/1-Interface_Imerged_Cauchy_modulated_enerfm03")
...
for i in [24]:
    ...
    mod03.append(frM)
    diffe03=energyM[-1]-energyM[0]
    diffener03.append(diffe03)
