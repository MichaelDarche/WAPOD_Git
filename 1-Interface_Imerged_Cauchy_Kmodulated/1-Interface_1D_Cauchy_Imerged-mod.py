...
import os
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/1-Interface_Imerged_Cauchy_Kmodulated")
...
import analytics as solana
NOde = 10000
SolAV=np.zeros(Nx)
SolAS=np.zeros(Nx)
for xi in range(Nx):
    SolAV[xi],SolAS[xi]=solana.analytics_Cauchy_1IModK(Tmax, X[xi], sourcef, modulation, frontiere, mat, NOde, dt, Nt)
# time0=time.time()
