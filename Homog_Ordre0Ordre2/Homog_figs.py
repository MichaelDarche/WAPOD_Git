...
for imod in range(5):
    ...
    dP1=np.loadtxt(nSvedP1, delimiter='\t')
    dP2=np.loadtxt(nSvedP2,delimiter='\t')
    ...
    plt.plot(X,U2C,color='blue',linestyle='None',marker='o',markersize=3,label=r'$U^{(2)}$')
    plt.xlabel(r'$X$ (m)',fontsize=16)
    plt.ylabel(r'$U$ (m)',fontsize=16)
    plt.title("$T=$"+str(round(tp[Ntfig], 3))+" s",fontsize=16)
    plt.legend(fontsize=14)#loc="lower right",)
    plt.tight_layout()
    namefigU='U2_K-1e9_fc'+str(fs)+'fm'+str(fm)+'.pdf'
    ...
    plt.legend(fontsize=14)#loc="lower right",)
    plt.tight_layout()
    namefigV='V2_K-1e9_fc'+str(fs)+'fm'+str(fm)+'.pdf'
    ...
    plt.legend(fontsize=14)#loc="lower right",)
    plt.tight_layout()
    namefigUz='U2z_K-1e9_fc'+str(fs)+'fm'+str(fm)+'.pdf'
    ...
    plt.legend(fontsize=14)#loc="lower right",)
    plt.tight_layout()
    namefigVz='V2z_K-1e9_fc'+str(fs)+'fm'+str(fm)+'.pdf'
