...
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/1-Interface_Imerged_PS_modulated2-NRQPT/")
...
plt.figure()
plt.plot(fmod,30*err[0,:],label=r'$f_c=30$ Hz',linewidth=3)
plt.plot(fmod,50*err[1,:],'--',label=r'$f_c=50$ Hz',linewidth=3)
plt.xlabel(r'$f_m$ (Hz)',fontsize=16)
plt.ylabel(r'$f_c\varepsilon_v$ (m)',fontsize=16)
