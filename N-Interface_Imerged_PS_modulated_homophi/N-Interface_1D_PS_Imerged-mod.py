...
import os
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/N-Interface_Imerged_PS_modulated_homophi/")
...
if tau!=0:
    ...
    ffg.dispFK_tperiodic2(Ufilm[:Ntfig,:],dt2p,dx,fmlist[0],kmax)
    for i in range(NE):
