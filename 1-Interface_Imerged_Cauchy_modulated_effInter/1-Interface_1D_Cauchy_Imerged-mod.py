...
import os
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/1-Interface_Imerged_Cauchy_modulated_effInter")
...
Resp,Vfilmp,Sfilmp,CSVMp=scheme1D.FD_cauchyII(U0,Ntfig,Nx,K,rhox,Celx,dt,dx,configuration,mat,frontierep,nomodulation,pFilm,rCSVM="yes")
Resm,Vfilmm,Sfilmm,CSVMm=scheme1D.FD_cauchyII(U0,Ntfig,Nx,K,rhox,Celx,dt,dx,configuration,mat,frontierem,nomodulation,pFilm,rCSVM="yes")
...
plt.plot(X, Resm[0,:],'--',linewidth=3,label="staticMin")
plt.plot(X, Resp[0,:],'--', linewidth=3,label="staticMax")
