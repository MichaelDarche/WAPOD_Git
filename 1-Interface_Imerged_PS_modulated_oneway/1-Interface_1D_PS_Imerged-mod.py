...
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/1-Interface_Imerged_PS_modulated_oneway/")
...
import time
time0=time.time()
Res,Vfilm,Sfilm,CSVM,traces=scheme1D.FD_sourceVIIOneWay(U0,Nt,Nx,K,rhox,Celx,dt,dx,x_0,sce,configuration,mat,frontiere,modulation,pFilm,rCSVM="yes",rtraces="yes")#:(U0,Nt,Nx,K,rhox,Celx,dt,dx,"no")
