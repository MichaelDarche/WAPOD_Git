...
import os
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/1-Interface_Imerged_PointSource/")
...
K=2    
Res=scheme1D.FD_sourceVII(U0,Nt,Nx,K,rhox,Celx,dt,dx,x0,sce,configuration,mat,frontiere,"no")
...
# for k in range(ndx):
#     k0=k0/2
#     Res=scheme1D.FD_sourceVII(U0,Nt,Nx,K,rhox,Celx,dt,k0*dx,configuration,mat,frontiere,"no")
