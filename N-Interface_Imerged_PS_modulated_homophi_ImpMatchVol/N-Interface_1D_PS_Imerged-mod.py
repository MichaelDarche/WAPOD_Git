...
import os
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/N-Interface_Imerged_PS_modulated_homophi_ImpMatchVol/")
...
def updateComp(frame):
    ...
    plt.imshow([rhox], cmap='gray', extent=[xmin, xmax, -np.max(VfilmSS),np.max(VfilmSS)], aspect='auto', alpha=0.35)
    plt.colorbar()
    # plt.plot(X, VfilmH[frame,:])
...
# Cree l'animation
animationComp = FuncAnimation(fig, updateComp, frames=total_frames, interval=0.1)
plt.show()
...
plt.tight_layout()
namefig="Figures/PRSA_U_HIM_MK_"+sourcef["Frequence"]+"_"+modulation["Freq"]+".pdf"
plt.savefig(str(namefig), format='pdf')
namefig="Figures/PRSA_U_HIM_MK_"+sourcef["Frequence"]+"_"+modulation["Freq"]+".png"
...
# plt.plot(VfilmH[500,:])
# plt.title("$nt=$500")
namefig="Figures/PRSA_V_HIM_MK_"+sourcef["Frequence"]+"_"+modulation["Freq"]+".pdf"
plt.savefig(str(namefig), format='pdf')
namefig="Figures/PRSA_V_HIM_MK_"+sourcef["Frequence"]+"_"+modulation["Freq"]+".png"
plt.savefig(str(namefig), format='png')
...
plt.xlim(zoomlim)
plt.tight_layout()
namefig="Figures/PRSAzoom_U_HIM_MK_"+sourcef["Frequence"]+"_"+modulation["Freq"]+".pdf"
plt.savefig(str(namefig), format='pdf')
namefig="Figures/PRSAzoom_U_HIM_MK_"+sourcef["Frequence"]+"_"+modulation["Freq"]+".png"
plt.savefig(str(namefig), format='png')
...
# plt.plot(VfilmH[500,:])
# plt.title("$nt=$500")
namefig="Figures/PRSAzoom_V_HIM_MK_"+sourcef["Frequence"]+"_"+modulation["Freq"]+".pdf"
plt.savefig(str(namefig), format='pdf')
namefig="Figures/PRSAzoom_V_HIM_MK_"+sourcef["Frequence"]+"_"+modulation["Freq"]+".png"
plt.savefig(str(namefig), format='png')
...
if tau!=0:
    ...
    ffg.dispFK_tperiodic2(Ufilm[:Ntfig,:],dt2p,dx,100,kmax)
    for i in range(NE):
