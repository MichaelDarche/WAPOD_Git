...
import os
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/Lesson1-Bloch-Gap/")
...
for ome in range(1,Nom):
    ...
    P=dispersionBloch.matT(omega,Ncouches,li,rho,cm)
...
# Affiche l'animation
plt.show()
nomAnim="Film_V_BG_"+sourcef["Frequence"]+"Hz.mp4"
