...
import os
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/1-Interface_Imerged_Cauchy_modulated_enerfm05")
...
for i in range(1,25):
    ...
    mod05.append(frM)
    diffe05=energyM[-1]-energyM[0]
    diffener05.append(diffe05)
