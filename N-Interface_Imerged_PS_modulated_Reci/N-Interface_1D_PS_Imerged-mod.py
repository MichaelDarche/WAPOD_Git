...
import os
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/N-Interface_Imerged_PS_modulated_Reci/")
...
ffg.sismo(X, t, Vfilm,20,pFilm,Nt=1500)

Ntfig=int(np.floor(0.25/dt2p))
...
# plt.plot(X,VfilmGS[Ntfig,:],linewidth=3,label=r'$V_0$')
...
# plt.plot(VfilmH[500,:])
# plt.title("$nt=$500")
# namefig="Figures/WP500_sin1_MK_"+sourcef["Frequence"]+"_"+modulation["Freq"]+".eps"
