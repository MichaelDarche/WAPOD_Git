...
import os
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/1-Interface_Imerged_Cauchy_modulated_enereps")
...
pFilm=1
Nmod=10
eps=np.linspace(-0.95,0.95,39)
diffener750=[]

for neps in range(eps.shape[0]):
    namemod="Modulation.txt"
    ...
    lineM="DeltaZ   :  "+str(eps[neps])+"\n"
    lineK="DeltaB   :  "+str(eps[neps])+"\n"
    ...
    diffe750=energyM[-1]-energyM[0]
    diffener750.append(diffe750)
