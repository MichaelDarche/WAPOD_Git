...
import os
os.chdir("/home/michael/Documents/ModulatedMetamaterials/WAPRO_TD/Homog-modulated/")
...
import time
time0=time.time()
Res,Vfilm,Sfilm=scheme1D.FD_sourceVIIHomoSSHdA(U0, Ntp, Nx, K, rhox, Celx, dt, dx, x_0, sce, configuration, mat,  modulation, pFilm) 
Res,Vfilm,Sfilm=scheme1D.FD_sourceVIIHomoSSHdA(U0, Ntp, Nx, K, rhox, Celx, dt, dx, x_0, sce, configuration, mat,  modulation, pFilm) 
...
plt.plot(X,THV100y)
plt.plot(X,Vfilm[-1,:])
np.savetxt("Vsave_10_4.txt",Vfilm,fmt='%18e', delimiter='\t')
np.savetxt("Ssave_10_4.txt",Sfilm,fmt='%18e', delimiter='\t')
